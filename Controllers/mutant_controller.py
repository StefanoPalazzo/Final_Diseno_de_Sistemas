...
app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv('postgresql://base_de_mutantes_user:LgA2ruxr3UYXfMxRLPz1nOcFNAkrVhNm@dpg-cskpn2rv2p9s73a9i6f0-a/base_de_mutantes')  # Variable de entorno
